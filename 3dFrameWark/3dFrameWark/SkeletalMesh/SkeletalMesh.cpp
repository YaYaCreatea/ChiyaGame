...
void SkeletalMesh::blendshape_animation(float l_attackRate, float l_damageRate, float l_smileRate)
{
	...
	MV1SetShapeRate(model_, 6, l_smileRate);
	MV1SetShapeRate(model_, 10, l_smileRate);
}
