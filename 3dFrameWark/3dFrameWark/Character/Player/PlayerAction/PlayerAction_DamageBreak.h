#ifndef _PLAYER_ACTION_DAMAGE_BREAK_H_
#define _PLAYER_ACTION_DAMAGE_BREAK_H_

#include "../PlayerActionBase.h"

class PlayerAction_DamageBreak :public PlayerActionBase
{
public:
	PlayerAction_DamageBreak(IWorld& world, PlayerParameters& parameter);
