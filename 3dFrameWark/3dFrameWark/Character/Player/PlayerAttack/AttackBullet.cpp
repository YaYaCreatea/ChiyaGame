	...
	m_bulletSpeed{ 2.5f }
{
	...
	bodyCapsule_ = BoundingCapsule{ Vector3{ 0.0f,3.0f,0.0f },Vector3{ 0.0f,3.0f,0.0f },m_radius };
...
void AttackBullet::update(float deltaTime)
{
	...
	if (m_timer <= 0.0f
		|| CollisionMesh::collide_capsule(m_position + Vector3{ 0.0f,3.0f,0.0f }, m_position + Vector3{ 0.0f,3.0f,0.0f }, m_radius, &m_position))
		m_isdead = true;
